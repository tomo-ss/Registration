...
<body>
  ...
  <main>
    ...
    <form action="update_confirm.php" method="POST">
      ...
      <label>メールアドレス：
        <input type="email" name="mail" maxlength="100" value="<?= htmlspecialchars($account['mail'] ?? '') ?>">
      </label>
...
<div class="form-row">
  ...
  <div class="gender-group">
    <div class="gender-option">
      <input type="radio" name="gender" value="0" <?= ($account['gender'] ?? '') == 0 ? 'checked' : '' ?>>
      <span>男</span>
    </div>
    <div class="gender-option">
      <input type="radio" name="gender" value="1" <?= ($account['gender'] ?? '') == 1 ? 'checked' : '' ?>>
      <span>女</span>
    </div>
  </div>
</div>
